...
#ifndef GOOGLESQL_PARSER_PARSER_MODE_H_
#define GOOGLESQL_PARSER_PARSER_MODE_H_

namespace googlesql {
namespace parser {

// Indicates what sort of GoogleSQL incantation we are parsing. This roughly
...
#endif  // GOOGLESQL_PARSER_PARSER_MODE_H_
