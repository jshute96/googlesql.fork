...
// An API that provides information on GoogleSQL keywords.
#ifndef GOOGLESQL_PARSER_KEYWORDS_H_
#define GOOGLESQL_PARSER_KEYWORDS_H_
...
#endif  // GOOGLESQL_PARSER_KEYWORDS_H_
