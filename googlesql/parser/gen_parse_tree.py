...
"""Defines parse tree nodes for the GoogleSQL parser.
...
from googlesql.parser import ast_enums_pb2
...
class NodeFormat:
  ...
  Passed as AddNode(format=NodeFormat(...)).  All attributes are inherited by
...
class FieldFormat:
  ...
  Passed as Field(format=FieldFormat(...)).  Roles let the formatter identify
...
def Field(
  ...
  Args:
    ...
    format: Optional FieldFormat giving this field's role in the node's
  ...
  def AddNode(self,
    ...
    Args:
      ...
      init_fields_order: Optional override to the default ordering of field
        initialization, which must match the grammar as defined in googlesql.tm.
      ...
      gen_init_fields: May be set to False in final classes to suppress
        ...
        non-final classes.
      format: Optional NodeFormat giving this node's formatter layout
...
def main(argv):
  ...
  bool IsSqlStatement() const override { return true; }
      """,
      format=NodeFormat(info_region='stmt'),
    )
  ...
  gen.AddNode(
      ...
      format=NodeFormat(layout='stack'),
  )
  ...
  gen.AddNode(
      ...
      parent='ASTQueryExpression',
      use_custom_debug_string=True,
      format=NodeFormat(layout='keyword_stack'),
      fields=[
          Field('hint', 'ASTHint', tag_id=2),
    ...
    """,
      fields=[
          Field(
              ...
              """,
              format=FieldFormat(region='table')),
          Field(
              'unnest_expr',
              'ASTUnnestExpression',
              tag_id=3),
 ...
 Calling this NamedType or TypeName may be more appropriate.
  ...
  gen.AddNode(
      ...
      parent='ASTExpression',
      use_custom_debug_string=True,
      format=NodeFormat(layout='call', info_region='func'),
      fields=[
          Field(
              'function',
              'ASTPathExpression',
  ...
  gen.AddNode(
      ...
      """,
      format=NodeFormat(layout='paren'),
      fields=[
          Field(
              'hint',
              'ASTHint',
          ...
          Field(
              ...
              tag_id=3,
              field_loader=FieldLoaderMethod.REQUIRED,
              format=FieldFormat(role='paren_body')),
          Field(
              'modifier',
              SCALAR_MODIFIER,
              tag_id=4,
  ...
  gen.AddNode(
      ...
      parent='ASTQueryExpression',
      use_custom_debug_string=True,
      format=NodeFormat(layout='set_chain'),
      fields=[
          Field(
              'metadata',
  ...
  gen.AddNode(
      name='ASTQuantifiedComparisonExpression',
      tag_id=548,
      parent='ASTExpression',
      comment="""
  ...
  gen.AddNode(
      ...
      """,
      format=NodeFormat(layout='statements'),
      fields=[
          Field(
              'statement_list',
              'ASTStatement',
...
""",
  ...
  # Spanner-specific node types, not part of the GoogleSQL language.
  gen.AddNode(
