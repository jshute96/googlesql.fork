...
std::vector<FunctionTestCall> GetFunctionTestsRegexp() {
  ...
  return {
      ...
      {"regexp_replace", {Bytes(""), Bytes(""), Bytes("")}, Bytes("")},
      {"regexp_replace",
       {Bytes("abc"), Bytes(""), Bytes("x")},
       Bytes("xaxbxcx")},
      {"regexp_replace",
       {Bytes("abc"), Bytes("x?"), Bytes("x")},
       Bytes("xaxbxcx")},
      {"regexp_replace",
       {Bytes("abc"), Bytes("b"), Bytes("xyz")},
       Bytes("axyzc")},
      {"regexp_replace",
       {Bytes("abcabc"), Bytes("bc"), Bytes("xyz")},
       Bytes("axyzaxyz")},
      {"regexp_replace",
       {Bytes("abc"), Bytes("abc"), Bytes("xyz")},
       Bytes("xyz")},
      {"regexp_replace",
       {Bytes("banana"), Bytes("ana"), Bytes("xyz")},
       Bytes("bxyzna")},
      {"regexp_replace",
       {Bytes("banana"), Bytes("ana"), Bytes("")},
       Bytes("bna")},
      {"regexp_replace",
       {Bytes("banana"), Bytes("a"), Bytes("z")},
       Bytes("bznznz")},
      {"regexp_replace",
       {Bytes("banana"), Bytes("(.)a(.)"), Bytes("\\1\\2")},
       Bytes("bnana")},
      {"regexp_replace",
       {Bytes("banana"), Bytes("."), Bytes("x")},
       Bytes("xxxxxx")},
      ...
      {"regexp_extract_all", {"щцф", "(.{6})"}, empty_string_array},
      {"regexp_extract_all", {"abc", "((a))"}, null_string_array, OUT_OF_RANGE},
      {"regexp_extract_all",
       {"abc", "(a)(b)"},
       null_string_array,
       OUT_OF_RANGE},
      ...
      {"regexp_extract_all",
       {Bytes("abcdef"), Bytes("a.c.*f")},
       BytesArray({"abcdef"})},
      {"regexp_extract_all",
       {Bytes("abcdef"), Bytes("ac.*e.")},
       empty_bytes_array},
      {"regexp_extract_all",
       {Bytes("abcdef"), Bytes("bcde")},
       BytesArray({"bcde"})},
      {"regexp_extract_all",
       {Bytes("aabca"), Bytes("a*")},
       BytesArray({"aa", "", "", "a"})},
      ...
      {"regexp_extract_all",
       {Bytes("abbb"), Bytes("^a*(b)")},
       BytesArray({"b"})},
      {"regexp_extract_all",
       {Bytes("XbASDZb"), Bytes("(.)b")},
       BytesArray({"X", "Z"})},
      {"regexp_extract_all",
       {Bytes("abcdef"), Bytes("a(.c.*)f")},
       BytesArray({"bcde"})},
...
std::vector<FunctionTestCall> GetFunctionTestsRegexp2(
  ...
  std::vector<FunctionTestCall> test_calls = {
      ...
      {"regexp_substr", {"-2020-jack-class1", "-[^.-]*", 2ll}, "-jack"},
      ...
      {"regexp_substr", {"-2020-jack-class1", "-[^.-]*", 1ll, 1ll}, "-2020"},
      {"regexp_extract", {"-2020-jack-class1", "-[^.-]*", 2ll, 1ll}, "-jack"},
      {"regexp_substr",
       {"-2020-jack-class1", "-[^.-]*", 7ll, 3ll},
       NullString()},
      ...
      {"regexp_extract", {"abc", "abc", 1ll, 0ll}, NullString(), OUT_OF_RANGE},
      {"regexp_substr", {"abc", "abc", 0ll, 1ll}, NullString(), OUT_OF_RANGE},
      {"regexp_extract",
       {"abc", "((a))", 1ll, 1ll},
       NullString(),
       OUT_OF_RANGE},
      {"regexp_substr",
       ...
       NullString(),
       OUT_OF_RANGE},
      {"regexp_extract", {"aa", "a", 1ll, -1ll}, NullString(), OUT_OF_RANGE},
      {"regexp_substr", {"aa", "a", -1ll, -1ll}, NullString(), OUT_OF_RANGE},
      ...
      {"regexp_substr",
       {Bytes("-2020-jack-class1"), Bytes("-[^.-]*"), 2ll},
       Bytes("-jack")},
      ...
      {"regexp_substr",
       {Bytes("aa"), Bytes("a"), -1ll},
       NullBytes(),
       OUT_OF_RANGE},
      // Invalid utf-8 second byte.
      {"regexp_extract",
       {Bytes("\x61\xa7\x65\x71"), Bytes("a"), 1ll},
       Bytes("a")},
      {"regexp_substr",
       {Bytes("\x61\xa7\x65\x71"), Bytes("a"), 2ll},
       NullBytes()},
      {"regexp_extract",
       {Bytes("\x61\xa7\x65\x71"), Bytes("a"), 2ll},
       NullBytes()},
      {"regexp_substr",
       {Bytes("\x61\xa7\x65\x71"), Bytes("a"), 3ll},
       NullBytes()},
      ...
      {"regexp_extract",
       {Bytes("abcabc"), Bytes("abc"), 4ll, 1ll},
       Bytes("abc")},
      {"regexp_substr",
       {Bytes("abcabcc"), Bytes("abc"), 1ll, 2ll},
       Bytes("abc")},
      {"regexp_extract",
       {Bytes("abcdefaazcddefg"), Bytes("a.c.*f"), 5ll, 1ll},
       Bytes("azcddef")},
      {"regexp_substr",
       {Bytes("abcabc"), Bytes("a(b)c"), 1ll, 2ll},
       Bytes("b")},
      {"regexp_extract",
       {Bytes("-2020-jack-class1"), Bytes("-[^.-]*"), 1ll, 1ll},
       Bytes("-2020")},
      {"regexp_substr",
       {Bytes("-2020-jack-class1"), Bytes("-[^.-]*"), 2ll, 1ll},
       Bytes("-jack")},
      {"regexp_extract",
       {Bytes("-2020-jack-class1"), Bytes("-[^.-]*"), 7ll, 3ll},
       NullBytes()},
      {"regexp_substr", {Bytes("щцф"), Bytes(".{2}"), 1ll, 3ll}, Bytes("ф")},
      {"regexp_extract",
       {Bytes("щцф"), Bytes(".{3}"), 2ll, 1ll},
       Bytes("\x89\xd1\x86")},
      {"regexp_extract",
       {Bytes("щцфц"), Bytes(".{2}"), 3ll, 2ll},
       Bytes("\xd1\x84")},
      {"regexp_substr",
       {Bytes("щцф"), Bytes(".{2}"), 3ll, 1ll},
       Bytes("\xd1\x86")},
      {"regexp_extract",
       {Bytes("щцф"), Bytes(".{3}"), 1ll, 1ll},
       Bytes("\xD1\x89\xD1")},
      {"regexp_substr",
       {Bytes("щцф"), Bytes(".{3}"), 1ll, 2ll},
       Bytes("\x86\xD1\x84")},
      ...
      {"regexp_substr",
       {Bytes("abc"), Bytes("abc"), 1ll, 0ll},
       NullBytes(),
       OUT_OF_RANGE},
      {"regexp_extract",
       {Bytes("abc"), Bytes("abc"), 0ll, 1ll},
       NullBytes(),
       OUT_OF_RANGE},
      {"regexp_substr",
       {Bytes("abc"), Bytes("((a))"), 1ll, 1ll},
       NullBytes(),
       OUT_OF_RANGE},
      {"regexp_extract",
       {Bytes("abc"), Bytes("(a)(b)"), 2ll, 1ll},
       NullBytes(),
       OUT_OF_RANGE},
      {"regexp_substr",
       {Bytes("aa"), Bytes("a"), 1ll, -1ll},
       NullBytes(),
       OUT_OF_RANGE},
      {"regexp_extract",
       {Bytes("aa"), Bytes("a"), -1ll, -1ll},
      ...
      // Invalid utf-8 second byte.
      {"regexp_extract",
       {Bytes("\x61\xa7\x65\x71"), Bytes("a"), 1ll, 2ll},
       NullBytes()},
      {"regexp_substr",
       {Bytes("\x61\xa7\x65\x71"), Bytes("a"), 2ll, 2ll},
       NullBytes()},

      // Additional tests for validating behavior of positional args.
      {"regexp_extract", {"xyzabc", "abc", 4ll}, "abc"},
      {"regexp_extract", {"xyzabc-abcz", "abc.", 4ll, 2ll}, "abcz"},
      {"regexp_extract", {Bytes("xyzabc"), Bytes("abc"), 4ll}, Bytes("abc")},
      {"regexp_extract",
       {Bytes("xyzabc-abcz"), Bytes("abc."), 4ll, 2ll},
       Bytes("abcz")},
      {"regexp_substr", {"xyzabc", "abc", 4ll}, "abc"},
      {"regexp_substr", {"xyzabc-abcz", "abc.", 4ll, 2ll}, "abcz"},
  ...
  test_calls.insert(test_calls.end(),
                    ...
                    legacy_position_arg_behavior_tests.end());
...
std::vector<FunctionTestCall> GetFunctionTestsRegexpInstr() {
  std::vector<FunctionTestCall> test_calls = {
      ...
      {"regexp_instr",
       ...
       OUT_OF_RANGE},
      // Invalid utf-8 second byte.
      {"regexp_instr", {Bytes("\x61\xa7\x65\x71"), Bytes("a"), 1ll}, 1ll},
      ...
      {"regexp_instr", {"abc", "abc", 1ll, 0ll}, NullInt64(), OUT_OF_RANGE},
      {"regexp_instr", {"abc", "abc", 0ll, 1ll}, NullInt64(), OUT_OF_RANGE},
      {"regexp_instr", {"abc", "((a))", 1ll, 1ll}, NullInt64(), OUT_OF_RANGE},
      {"regexp_instr", {"abc", "(a)(b)", 2ll, 1ll}, NullInt64(), OUT_OF_RANGE},
      {"regexp_instr", {"aa", "a", 1ll, -1ll}, NullInt64(), OUT_OF_RANGE},
      {"regexp_instr", {"aa", "a", -1ll, -1ll}, NullInt64(), OUT_OF_RANGE},
      ...
      {"regexp_instr",
       {NullString(), NullString(), 2ll, 2ll, 1ll},
       NullInt64()},
      ...
      {"regexp_instr",
       {"test-oscar-test-98-test-99", "test", 2ll, 2ll, 1ll},
       24ll},
      ...
      {"regexp_instr",
       ...
       NullInt64(),
       OUT_OF_RANGE},
      {"regexp_instr", {"aa", "a", 1ll, -1ll, 1ll}, NullInt64(), OUT_OF_RANGE},
      {"regexp_instr", {"aa", "a", -1ll, -1ll, 1ll}, NullInt64(), OUT_OF_RANGE},
      {"regexp_instr",
       {"aa", "a", 1ll, 1ll, int64min},
       NullInt64(),
       OUT_OF_RANGE},
      {"regexp_instr", {"aa", "a", -1ll, -1ll, 2ll}, NullInt64(), OUT_OF_RANGE},
      ...
      {"regexp_instr",
       {Bytes("abcdefaazcddefg"), Bytes("a.c.*f"), 5ll, 1ll, 1ll},
       15ll},
      {"regexp_instr", {Bytes("abcabc"), Bytes("a(b)c"), 1ll, 2ll, 1ll}, 6ll},
      {"regexp_instr",
       {Bytes("-2020-jack-class1"), Bytes("-[^.-]*"), 1ll, 1ll, 0ll},
       1ll},
      {"regexp_instr",
       {Bytes("-2020-jack-class1"), Bytes("-[^.-]*"), 2ll, 1ll, 1ll},
       11ll},
      {"regexp_instr",
       {Bytes("-2020-jack-class1"), Bytes("-[^.-]*"), 7ll, 3ll, 1ll},
       0ll},
      ...
      {"regexp_instr",
       {Bytes("abc"), Bytes("abc"), 1ll, 0ll, 1ll},
       NullInt64(),
       OUT_OF_RANGE},
      {"regexp_instr",
       {Bytes("abc"), Bytes("abc"), 0ll, 1ll, 0ll},
       NullInt64(),
       OUT_OF_RANGE},
      {"regexp_instr",
       {Bytes("abc"), Bytes("((a))"), 1ll, 1ll, 1ll},
       NullInt64(),
       OUT_OF_RANGE},
      {"regexp_instr",
       {Bytes("abc"), Bytes("(a)(b)"), 2ll, 1ll, 1ll},
       NullInt64(),
       OUT_OF_RANGE},
      {"regexp_instr",
       {Bytes("aa"), Bytes("a"), 1ll, -1ll, 1ll},
       NullInt64(),
       OUT_OF_RANGE},
      {"regexp_instr",
       {Bytes("aa"), Bytes("a"), -1ll, -1ll, 0ll},
       NullInt64(),
       OUT_OF_RANGE},
      {"regexp_instr",
       {Bytes("abc"), Bytes("abc"), 1ll, 1ll, -1ll},
       NullInt64(),
       OUT_OF_RANGE},
      {"regexp_instr",
       {Bytes("abc"), Bytes("abc"), 1ll, 0ll, int64max},
       NullInt64(),
       OUT_OF_RANGE},
      {"regexp_instr",
       {Bytes("abc"), Bytes("abc"), 1ll, 0ll, NullInt64()},
       NullInt64()},
      {"regexp_instr",
       {Bytes("abc"), Bytes("abc"), NullInt64(), 0ll, 1ll},
       NullInt64()},
      {"regexp_instr",
       {Bytes("abc"), Bytes("abc"), 1ll, NullInt64(), 0ll},
       NullInt64()},

      // Invalid utf-8 second byte.
      {"regexp_instr",
       {Bytes("\x61\xa7\x65\x71"), Bytes("a"), 1ll, 2ll, 0ll},
       0ll},
      {"regexp_instr",
       {Bytes("\x61\xa7\x65\x71"), Bytes("a"), 2ll, 2ll, 1ll},
       0ll},

      // Additional tests for validating behavior of positional args.
      {"regexp_instr", {"xyzabc", "abc", 4ll}, 4ll},
      {"regexp_instr", {"xyzabc-abcz", "abc.", 4ll, 2ll}, 8ll},
      {"regexp_instr", {"xyzabc-abcz", "abc.", 4ll, 1ll, 0ll}, 4ll},
      {"regexp_instr", {"xyzabc-abcz", "abc.", 4ll, 1ll, 1ll}, 8ll},
      {"regexp_instr", {Bytes("xyzabc"), Bytes("abc"), 4ll}, 4ll},
      {"regexp_instr", {Bytes("xyzabc-abcz"), Bytes("abc."), 4ll, 2ll}, 8ll},
      {"regexp_instr",
       {Bytes("xyzabc-abcz"), Bytes("abc."), 4ll, 1ll, 0ll},
       4ll},
      {"regexp_instr",
       {Bytes("xyzabc-abcz"), Bytes("abc."), 4ll, 1ll, 1ll},
       8ll},
  };
