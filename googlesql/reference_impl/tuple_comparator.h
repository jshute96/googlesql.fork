...
#ifndef GOOGLESQL_REFERENCE_IMPL_TUPLE_COMPARATOR_H_
#define GOOGLESQL_REFERENCE_IMPL_TUPLE_COMPARATOR_H_
...
#endif  // GOOGLESQL_REFERENCE_IMPL_TUPLE_COMPARATOR_H_
