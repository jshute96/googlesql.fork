...
#ifndef GOOGLESQL_TOOLS_EXECUTE_QUERY_VALUE_AS_TABLE_ADAPTER_H_
#define GOOGLESQL_TOOLS_EXECUTE_QUERY_VALUE_AS_TABLE_ADAPTER_H_
...
#endif  // GOOGLESQL_TOOLS_EXECUTE_QUERY_VALUE_AS_TABLE_ADAPTER_H_
