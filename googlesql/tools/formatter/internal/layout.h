...
#ifndef GOOGLESQL_TOOLS_FORMATTER_INTERNAL_LAYOUT_H_
#define GOOGLESQL_TOOLS_FORMATTER_INTERNAL_LAYOUT_H_
...
#endif  // GOOGLESQL_TOOLS_FORMATTER_INTERNAL_LAYOUT_H_
