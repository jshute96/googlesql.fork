...
#ifndef THIRD_PARTY_GOOGLESQL_GOOGLESQL_BASE_ENUM_UTILS_H_
#define THIRD_PARTY_GOOGLESQL_GOOGLESQL_BASE_ENUM_UTILS_H_
...
#endif  // THIRD_PARTY_GOOGLESQL_GOOGLESQL_BASE_ENUM_UTILS_H_
