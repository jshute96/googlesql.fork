...
#ifndef THIRD_PARTY_GOOGLESQL_GOOGLESQL_BASE_GENERAL_TRIE_H_
#define THIRD_PARTY_GOOGLESQL_GOOGLESQL_BASE_GENERAL_TRIE_H_
...
#endif  // THIRD_PARTY_GOOGLESQL_GOOGLESQL_BASE__GENERAL_TRIE_H_
