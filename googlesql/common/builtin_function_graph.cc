...
static absl::StatusOr<const Type*> ComputePathNodeType(
  ...
  GOOGLESQL_RET_CHECK(arguments.size() == 1);
  GOOGLESQL_RET_CHECK(arguments[0].type()->IsGraphPath());
...
static absl::StatusOr<const Type*> ComputePathNodesType(
  ...
  GOOGLESQL_RETURN_IF_ERROR(type_factory->MakeArrayType(
...
static absl::StatusOr<const Type*> ComputePathCreateType(
  ...
  GOOGLESQL_RET_CHECK(!graph_element_arguments.empty());
  GOOGLESQL_RET_CHECK(
  ...
  for (int i = 0; i < graph_element_arguments.size(); ++i) {
    if (i % 2 == 0) {
      GOOGLESQL_RET_CHECK(graph_element_arguments[i].type()->AsGraphElement()->IsNode());
      node_types.Insert(graph_element_arguments[i]);
    } else {
      GOOGLESQL_RET_CHECK(graph_element_arguments[i].type()->AsGraphElement()->IsEdge());
  ...
  GOOGLESQL_RETURN_IF_ERROR(coercer.GetCommonSuperType(node_types, &node_type));
  GOOGLESQL_RET_CHECK(node_type != nullptr);
  ...
  if (edge_types.empty()) {
    ...
    GOOGLESQL_RETURN_IF_ERROR(coercer.GetCommonSuperType(edge_types, &supertype));
    GOOGLESQL_RET_CHECK(supertype != nullptr);
    GOOGLESQL_RET_CHECK(supertype->IsGraphElement());
    edge_type = supertype->AsGraphElement();
  }
  const GraphPathType* path_type = nullptr;
  GOOGLESQL_RETURN_IF_ERROR(type_factory->MakeGraphPathType(node_type->AsGraphElement(),
                                                  edge_type, &path_type));
  return path_type;
}
...
void GetGraphFunctions(TypeFactory* type_factory,
  ...
  InsertFunction(
      ...
      {{bool_type,
        {ARG_KIND_EXPR_GRAPH_NODE, ARG_KIND_EXPR_GRAPH_EDGE},
        FN_IS_SOURCE_NODE}},
      FunctionOptions()
  ...
  InsertFunction(
      ...
      {{bool_type,
        {{ARG_KIND_EXPR_GRAPH_ELEMENT, FunctionArgumentType::REPEATED}},
  ...
  InsertFunction(
      ...
      {{string_type, {{ARG_KIND_EXPR_GRAPH_EDGE}}, FN_SOURCE_NODE_ID}},
      FunctionOptions()
          .AddRequiredLanguageFeature(LanguageFeature::FEATURE_SQL_GRAPH)
          .set_supports_safe_error_mode(false)
          .set_volatility(FunctionEnums::STABLE));
  ...
  InsertFunction(
      ...
      {{string_type, {{ARG_KIND_EXPR_GRAPH_EDGE}}, FN_DESTINATION_NODE_ID}},
      FunctionOptions()
          .AddRequiredLanguageFeature(LanguageFeature::FEATURE_SQL_GRAPH)
          .set_supports_safe_error_mode(false)
          .set_volatility(FunctionEnums::STABLE));
  ...
  InsertFunction(
      ...
      {{string_type,
        {{ARG_KIND_EXPR_GRAPH_ELEMENT}},
        FN_ELEMENT_DEFINITION_NAME}},
      FunctionOptions()
          .AddRequiredLanguageFeature(LanguageFeature::FEATURE_SQL_GRAPH)
          .set_supports_safe_error_mode(false));

  InsertFunction(functions, options, "path_length", Function::SCALAR,
                 {{int64_type, {{ARG_KIND_EXPR_GRAPH_PATH}}, FN_PATH_LENGTH}},
                 FunctionOptions()
  ...
  InsertFunction(
      ...
      {{ARG_KIND_EXPR_ARBITRARY, {{ARG_KIND_EXPR_GRAPH_PATH}}, FN_PATH_NODES}},
      FunctionOptions()
          .AddRequiredLanguageFeature(FEATURE_SQL_GRAPH)
          .AddRequiredLanguageFeature(FEATURE_SQL_GRAPH_PATH_TYPE)
          .set_supports_safe_error_mode(false)
  ...
  InsertFunction(
      ...
      {{ARG_KIND_EXPR_ARBITRARY, {{ARG_KIND_EXPR_GRAPH_PATH}}, FN_PATH_EDGES}},
      FunctionOptions()
          .AddRequiredLanguageFeature(FEATURE_SQL_GRAPH)
          .AddRequiredLanguageFeature(FEATURE_SQL_GRAPH_PATH_TYPE)
          .set_supports_safe_error_mode(false)
  ...
  InsertFunction(
      ...
      {{ARG_KIND_EXPR_ARBITRARY, {{ARG_KIND_EXPR_GRAPH_PATH}}, FN_PATH_FIRST}},
      FunctionOptions()
          .AddRequiredLanguageFeature(FEATURE_SQL_GRAPH)
          .AddRequiredLanguageFeature(FEATURE_SQL_GRAPH_PATH_TYPE)
          .set_supports_safe_error_mode(false)
  ...
  InsertFunction(
      ...
      {{ARG_KIND_EXPR_ARBITRARY, {{ARG_KIND_EXPR_GRAPH_PATH}}, FN_PATH_LAST}},
      FunctionOptions()
          .AddRequiredLanguageFeature(FEATURE_SQL_GRAPH)
          .AddRequiredLanguageFeature(FEATURE_SQL_GRAPH_PATH_TYPE)
          .set_supports_safe_error_mode(false)
  ...
  InsertFunction(
      functions, options, "path", Function::SCALAR,
      {
          {ARG_KIND_EXPR_ARBITRARY,
           {ARG_KIND_EXPR_GRAPH_NODE,
            {ARG_KIND_EXPR_GRAPH_EDGE, FunctionArgumentType::REPEATED},
            {ARG_KIND_EXPR_GRAPH_NODE, FunctionArgumentType::REPEATED}},
           FN_PATH_CREATE},
      },
      FunctionOptions()
          .AddRequiredLanguageFeature(FEATURE_SQL_GRAPH)
  ...
  InsertFunction(functions, options, "is_acyclic", Function::SCALAR,
                 {{bool_type, {{ARG_KIND_EXPR_GRAPH_PATH}}, FN_IS_ACYCLIC}},
                 FunctionOptions()
                     .AddRequiredLanguageFeature(FEATURE_SQL_GRAPH)
                     .AddRequiredLanguageFeature(FEATURE_SQL_GRAPH_PATH_TYPE)
                     .set_supports_safe_error_mode(false)
  ...
  InsertFunction(functions, options, "is_trail", Function::SCALAR,
                 {{bool_type, {{ARG_KIND_EXPR_GRAPH_PATH}}, FN_IS_TRAIL}},
                 FunctionOptions()
                     .AddRequiredLanguageFeature(FEATURE_SQL_GRAPH)
                     .AddRequiredLanguageFeature(FEATURE_SQL_GRAPH_PATH_TYPE)
                     .set_supports_safe_error_mode(false)
  ...
  InsertFunction(functions, options, "is_simple", Function::SCALAR,
                 {{bool_type, {{ARG_KIND_EXPR_GRAPH_PATH}}, FN_IS_SIMPLE}},
                 FunctionOptions()
                     .AddRequiredLanguageFeature(FEATURE_SQL_GRAPH)
                     .AddRequiredLanguageFeature(FEATURE_SQL_GRAPH_PATH_TYPE)
                     .set_supports_safe_error_mode(false)
  ...
  InsertFunction(
      ...
      {{bool_type,
        {ARG_KIND_EXPR_GRAPH_ELEMENT, string_type, ARG_KIND_EXPR_ANY_1},
