...
#ifndef GOOGLESQL_COMMON_TIMER_UTIL_H_
#define GOOGLESQL_COMMON_TIMER_UTIL_H_
...
// A timer for recording usage of CPU, stack, etc. inside GoogleSQL.
class ElapsedTimer {
 public:
...
#endif  // GOOGLESQL_COMMON_TIMER_UTIL_H_
