...
#ifndef GOOGLESQL_ANALYZER_ANALYZER_OUTPUT_MUTATOR_H_
#define GOOGLESQL_ANALYZER_ANALYZER_OUTPUT_MUTATOR_H_
...
#endif  // GOOGLESQL_ANALYZER_ANALYZER_OUTPUT_MUTATOR_H_
