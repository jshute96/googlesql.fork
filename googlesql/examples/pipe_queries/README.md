...
demonstrating [SQL pipe
syntax](https://github.com/google/googlesql/blob/master/docs/pipe-syntax.md).

These mostly use tables from the TPC-H schema. For more information, see
[examples/tpch](https://github.com/google/googlesql/tree/master/googlesql/examples/tpch)
...
line. See
[execute\_query](https://github.com/google/googlesql/blob/master/execute_query.md)
...
For more information on pipe query syntax, see the [reference
documentation](https://github.com/google/googlesql/blob/master/docs/pipe-syntax.md)
