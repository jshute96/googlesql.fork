...
#ifndef GOOGLESQL_PUBLIC_ANNOTATION_DEFAULT_ANNOTATION_SPEC_H_
#define GOOGLESQL_PUBLIC_ANNOTATION_DEFAULT_ANNOTATION_SPEC_H_
...
#endif  // GOOGLESQL_PUBLIC_ANNOTATION_DEFAULT_ANNOTATION_SPEC_H_
