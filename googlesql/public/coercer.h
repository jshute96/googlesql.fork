...
#ifndef GOOGLESQL_PUBLIC_COERCER_H_
#define GOOGLESQL_PUBLIC_COERCER_H_
...
// allowed by GoogleSQL.  The full specification for casting and coercion is
// at:
//
//   (broken link)
//
...
#endif  // GOOGLESQL_PUBLIC_COERCER_H_
