<!--
  resolved_ast.md generated from template:
    https://github.com/google/googlesql/blob/master/googlesql/resolved_ast/resolved_ast.md.template

  Generated by target:
    //googlesql/resolved_ast:run_gen_resolved_ast_md
-->

# GoogleSQL Resolved AST

The GoogleSQL analyzer produces an abstract syntax tree (AST). The nodes of this
AST (ResolveAST) are generated by
[https://github.com/google/googlesql/blob/master/googlesql/resolved_ast/gen_resolved_ast.py] for both C++
and Java using bazel genrules. This document provides a summary of the nodes and
their hierarchy.

The C++ classes for the AST produced by the GoogleSQL parser are documented in
googlesql/docs/parse_ast.md.

### C++ {#ResolvedNode}

The base class `ResolvedNode` is defined in
[https://github.com/google/googlesql/blob/master/googlesql/resolved_ast/resolved_node.h](https://github.com/google/googlesql/blob/master/googlesql/resolved_ast/resolved_node.h)

The generated classes are specified in
[https://github.com/google/googlesql/blob/master/googlesql/resolved_ast/gen_resolved_ast.py](https://github.com/google/googlesql/blob/master/googlesql/resolved_ast/gen_resolved_ast.py)
See that file for comments on specific nodes and fields.

Additional non-generated classes that are documented separately:

- <a id="ResolvedColumn"></a>[ResolvedColumn](https://github.com/google/googlesql/blob/master/googlesql/resolved_ast/resolved_column.h)
- <a id="ResolvedCollation"></a>[ResolvedCollation](https://github.com/google/googlesql/blob/master/googlesql/resolved_ast/resolved_collation.h)

### Java

The base class `ResolvedNode` is defined in
[https://github.com/google/googlesql/blob/master/java/com/google/googlesql/resolvedast/ResolvedNode.java](https://github.com/google/googlesql/blob/master/java/com/google/googlesql/resolvedast/ResolvedNode.java)
...
- [ResolvedColumn](https://github.com/google/googlesql/blob/master/java/com/google/googlesql/resolvedast/ResolvedColumn.java)
...
// the `name` field is non-empty.</font>
...
//   - When used in <a href="#ResolvedAlterTableStmt">ResolvedAlterTableStmt</a>, the &lt;expression&gt; can contain
//     <a href="#ResolvedColumnRef">ResolvedColumnRefs</a> corresponding to any of the columns from
//     <a href="#ResolvedAlterTableStmt">ResolvedAlterTableStmt</a>.&lt;table_scan&gt;.
...
// (The validator cannot currently check this.)</font>
class ResolvedStringWithLocation : public <a href="#ResolvedArgument">ResolvedArgument</a> {
  static const ResolvedNodeKind TYPE = RESOLVED_STRING_WITH_LOCATION;
...
// The currently supported list is in `googlesql.tm` and `validator.cc`.</font>
class ResolvedStatementWithPipeOperatorsStmt : public <a href="#ResolvedStatement">ResolvedStatement</a> {
  ...
  const <a href="#ResolvedStringWithLocation">ResolvedStringWithLocation</a>* suffix_subpipeline_sql() const;
};
</code></pre></p>
...
// treated as if it were set to a NULL value of the element type.</font>
class ResolvedUpdateItemElement : public <a href="#ResolvedArgument">ResolvedArgument</a> {
  ...
  typedef <a href="#ResolvedUpdateItemElementEnum">ResolvedUpdateItemElementEnums</a>::UpdateItemMode UpdateItemMode;
  static const UpdateItemMode ELEMENT_PRESENCE_UNSPECIFIED = <a href="#ResolvedUpdateItemElementEnum">ResolvedUpdateItemElementEnums</a>::ELEMENT_PRESENCE_UNSPECIFIED;
  static const UpdateItemMode ELEMENT_PRESENCE_REQUIRED = <a href="#ResolvedUpdateItemElementEnum">ResolvedUpdateItemElementEnums</a>::ELEMENT_PRESENCE_REQUIRED;
  static const UpdateItemMode ELEMENT_PRESENCE_OPTIONAL = <a href="#ResolvedUpdateItemElementEnum">ResolvedUpdateItemElementEnums</a>::ELEMENT_PRESENCE_OPTIONAL;
...
<font color="brown">  // Specifies behavior when the subscript expression references an
  // element that doesn&#39;t exist.</font>
  <a href="#ResolvedUpdateItemElement">ResolvedUpdateItemElement</a>::UpdateItemMode update_item_mode() const;
};
</code></pre></p>
...
<font color="brown">  // A TableScan for the target table, which provides
  // <a href="#ResolvedColumnRef">ResolvedColumnRefs</a> for its currently-existing columns. These
  // can be referenced in <a href="#ResolvedGeneratedColumnInfo">ResolvedGeneratedColumnInfo</a> inside
  // &lt;alter_action_list&gt;. This field is optional, but required if
  // any <a href="#ResolvedAlterAction">ResolvedAlterAction</a> needs to reference
  // <a href="#ResolvedColumnRef">ResolvedColumnRefs</a>.</font>
  const <a href="#ResolvedTableScan">ResolvedTableScan</a>* table_scan() const;
};
</code></pre></p>
...
// If &lt;is_measure&gt; is true, it represents a measure definition.</font>
